...
function commentThreadsListByVideoId(part, videoId) {
  var response = YouTube.CommentThreads.list(part,{'videoId': videoId});
  printResults(response);
}
...
function Main() {
  ...
  //subscriptionsListByChannelId('snippet,contentDetails', 'UC2g_-ipVjit6ZlACPWG4JvA');
  //subscriptionsListForChannelId('snippet,contentDetails', 'UC2g_-ipVjit6ZlACPWG4JvA', true);
  channelsListById('snippet,contentDetails,statistics', 'UC2g_-ipVjit6ZlACPWG4JvA');
